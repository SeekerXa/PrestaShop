...
class custombannersmain extends Module implements WidgetInterface
{
    public function __construct()
    {
        $this->name = 'custombannersmain';
        ...
        $this->displayName = $this->l('Custom Banners Main');
        $this->description = $this->l('Allows users to upload and display custom banners.');

        $this->confirmUninstall = $this->l('Are you sure you want to uninstall the Custom Banners Main module?');

        if (!Configuration::get('CUSTOMBANNERSMAIN_BANNERS')) {
            $this->warning = $this->l('No banners have been uploaded yet.');
        }
    }
    ...
    public function hookDisplayWidget($params)
    {
        ...
        return $this->display(__FILE__, 'custombannersmain.tpl');
    }
    ...
    public function renderWidget($hookName, array $configuration)
    {
        ...
        if ($hookName === 'displayHome') {
            ...
            return $this->fetch('module:custombannersmain/custombannersmain.tpl');
        }
        return '';
    }
